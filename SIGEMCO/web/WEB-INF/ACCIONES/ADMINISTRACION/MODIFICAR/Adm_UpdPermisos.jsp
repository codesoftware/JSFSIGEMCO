                                        ...
                                        <div class="col-md-12 col-sm-12 col-xs-12">
                                            <table style="width: 100%">
                                                ...
                                                <tbody style="display: none;" class="subPermisoFacCrea">
                                                    ...
                                                    <tr>
                                                        <td>Solicitud de Remisiones</td>
                                                        <td><input type="checkbox" value="FcCr13" id="FcCr13"/></td>
                                                        <td>Generar Remision</td>
                                                        <td><input type="checkbox" value="FcCr14" id="FcCr14"/></td>
                                                    </tr>
                                                    <tr>
                                                        <td>Consulta Remisiones</td>
                                                        <td><input type="checkbox" value="FcCr15" id="FcCr15"/></td>
                                                        <td>Generar Factura Apartir Remis&oacute;n</td>
                                                        <td><input type="checkbox" value="FcCr16" id="FcCr16"/></td>
                                                    </tr>
                                                </tbody>
                                            </table>
                                        </div>
